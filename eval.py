...
from data.SIXrayDetection import MY_CLASSES as labelmap, SIXrayDetection, SIXrayAnnotationTransform
...
devkit_path = args.voc_root + 'RESULT'
...
def do_python_eval(output_dir='output', dataset= None):
...
"""
    ...
    if not os.path.isfile(cachefile):
        ...
        recs = {}
        for i, imagename in enumerate(imagenames):
            if imagename.startswith("coreless"):
                type_ = "coreless"
            else:
                type_ = "core"
...
if __name__ == '__main__':
    ...
    dataset = SIXrayDetection(root=args.voc_root, images_set_file=None,
